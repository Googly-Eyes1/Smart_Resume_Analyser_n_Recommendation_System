...
import os
os.environ["PAFY_BACKEND"] = "internal"  # This sets the internal backend for pafy
import yt_dlp
...
connection = pymysql.connect(host='localhost',user='Abi',password='Abi@2024*')
...
def run():
    ...
    if choice == 'Normal User':
        ...
        if st.button('Login'):
            if ad_user == 'Abirami' and ad_password == 'Abi123':
                st.success("Welcome Abirami")
                # Display Data
